...
namespace Backend.Models
{
    public class Courier
    {
        ...
        public required string Id { get; set; } // Unique identifier for the courier record.

        [BsonElement("order_id")] // Maps this property to the "order_id" field in MongoDB.
        public required string OrderId { get; set; } // The ID of the order associated with this courier.
        ...
        public required string Status { get; set; } // The current status of the courier (e.g., "shipped", "delivered").
    }
}
